...
output_path = os.path.join(os.path.dirname(__file__), 'dados_docentes_raca.json')
with open(output_path, 'w', encoding='utf-8') as f:
    json.dump(dados_json, f, ensure_ascii=False, indent=4)

print(f"JSON com dados de raça de docentes gerado com sucesso em {output_path}")

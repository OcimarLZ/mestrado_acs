...
SELECT
    ...
    SUM(cc.qt_ing_0_17) AS "17anos",
    SUM(cc.qt_ing_18_24) AS "18a24anos",
    SUM(cc.qt_ing_25_29) AS "25a29anos",
    SUM(cc.qt_ing_30_34 + cc.qt_ing_35_39) AS "30a39anos",
    SUM(cc.qt_ing_40_49 + cc.qt_ing_50_59) AS "40a59anos",
    SUM(cc.qt_ing_60_mais) AS "60oumais"
FROM
    curso_censo cc
JOIN
...
df_pivot = df.pivot_table(index='ano', columns='modalidade', values=["17anos", "18a24anos", "25a29anos", "30a39anos", "40a59anos", "60oumais"]).fillna(0)
...
faixas_etarias = ["17anos", "18a24anos", "25a29anos", "30a39anos", "40a59anos", "60oumais"]
...
output_json_path = os.path.abspath(os.path.join(os.path.dirname(__file__), 'dados_discentes_idade_ingressantes_modalidade.json'))

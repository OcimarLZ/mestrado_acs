...
# Query SQL fornecida pelo usuário (modificada para tp_modalidade_ensino = 2)
SQL_QUERY = """
...
output_html_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'static', 'tabelas', 'top20_cursos_distancia.html'))
...
output_excel_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'static', 'tabelas', 'top20_cursos_distancia.xlsx'))

...
# Query SQL para extrair dados de matrículas por políticas de inclusão - Rede Privada
query = """
SELECT 
    cc.ano_censo AS ano, 
    r.nome as tipo_rede, 
...
# Salvar como JSON
with open('dados_inclusao_matriculados_privada.json', 'w', encoding='utf-8') as f:
    json.dump(data, f, ensure_ascii=False, indent=2)

print(f"Arquivo dados_inclusao_matriculados_privada.json gerado com sucesso!")
print(f"Anos: {anos}")
